...
# Read in the data
taiwan_accidents_historical <- fread( "data/taiwan_accidents/taiwan_accidents_historical_raw.csv")

taiwan_accidents_historical_zh <- taiwan_accidents_historical |>
  ...
  mutate(
         ...
         #發生時間 = paste0(`發生時-Hours`,":", 發生分),
         發生日期時間 = floor_date(ymd_hm(paste(發生日期, 發生時間)), unit = "hour")
         #區序 = str_remove(區序, "\\d+"),
